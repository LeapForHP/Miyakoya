...
// ../.wrangler/tmp/bundle-pSZhGo/checked-fetch.js
...
async function onRequestPost(context) {
  try {
    ...
    const TO_EMAIL = env.TO_EMAIL || "info@leaders-co.jp";
      ...
      content: [
        {
          ...
          value: `
            ...
            <p>\u9001\u4FE1\u65E5\u6642: ${(/* @__PURE__ */ new Date()).toLocaleString("ja-JP", { timeZone: "Asia/Tokyo" })}</p>
          `
        }
      ]
    };
...
// ../.wrangler/tmp/pages-tUhra1/functionsRoutes-0.7556885831730147.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-pSZhGo/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-pSZhGo/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7605779995224825.mjs.map
